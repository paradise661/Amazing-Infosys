...
class MenuController extends Controller
{
    public function index()
    {
        ...
        return view('admin.menu.index', ['posts' => News::where('status', 1)->get(), 'pages' => Page::where('status', 1)->get(), 'blogcategorys' => Blogcategory::where('status', 1)->where('parent_id', 0)->get(), 'services' => Services::where('status', 1)->get(), 'menus' => MenuLocation::all(), 'desiredMenu' => $desiredMenu, 'menuitems' => $menuitems]);
    }
