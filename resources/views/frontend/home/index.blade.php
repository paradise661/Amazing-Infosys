...
@section('content')
                                                ...
                                                <section class="choose-area">
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col-lg-6 order-0 order-lg-2">
                                                                <div class="choose-img-wrap">
                                                                    ...
                                                                    <img src="{{ asset('frontend') }}/assets/img/images/choose_img_shape.png" alt="Apexa"
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="choose-content">
                                                                    <div class="section-title white-title mb-30 tg-heading-subheading animation-style3">
                                                                        <span class="sub-title text-primary">Graphic Design Packages For</span>
                                                                        <h2 class="title tg-element-title text-primary">
                                                                            {{ $whowe->name ?? '' }}
                                                                        </h2>
                                                                    </div>
                                                                    <p class="text-justify text-primary">{!! $whowe->description ?? '' !!}</p>
                                                    ...
                                                    <div class="choose-shape-wrap">
                                                        <img src="{{ asset('frontend') }}/assets/img/images/choose_shape01.png" alt="Apexa" data-aos="fade-right"
                                                            data-aos-delay="400" />
                                                        <img class="dark-opacity" src="{{ asset('frontend') }}/assets/img/images/choose_shape02.png" alt="Apexa" data-aos="fade-left"
                                                            data-aos-delay="400" />
                                                    </div>
                                                </section>
                                                <!-- choose-area-end -->
    ...
    $icons = [0 => 'flaticon-trophy', 1 => 'flaticon-happy', 2 => 'flaticon-user']
                                                ...
                                                <section class="request-area request-bg"  data-background="{{ get_image($request->image, '', 'home-project') }}">
                                                        ...
                                                        <div class="row justify-content-center">
                                                            <div class="col-lg-8">
                                                                <div class="request-content text-center tg-heading-subheading animation-style3">
                                                                    <h2 class="title tg-element-title text-white">{{ $request->name ?? '' }}</h2>
                                                    ...
                                                    <div class="request-shape">
                                                        <img src="{{ asset('frontend') }}/assets/img/images/request_shape01.png" alt="Apexa" data-aos="fade-right"
                                                            data-aos-delay="400" />
                                                        <img src="{{ asset('frontend') }}/assets/img/images/request_shape02.png" alt="Apexa" data-aos="fade-left"
                                                            data-aos-delay="400" />
                                                    </div>
                                                </section>
                                                <!-- request-area-end -->
                                                ...
                                                <section class="testimonial-area">
                                                    ...
                                                    <div class="testimonial-shape-wrap">
                                                        <img src="{{ asset('frontend') }}/assets/img/images/testimonial_shape05.png" alt="Apexa" data-aos="fade-up"
                                                            data-aos-delay="400" />
                                                        <img class="dark-opacity" src="{{ asset('frontend') }}/assets/img/images/testimonial_shape06.png" alt="Apexa"
