                ...
                <main class="fix">
                    ...
                    <section class="choose-area">
                                ...
                                <div class="col-lg-6">
                                    <div class="choose-content">
                                        <div class="section-title white-title mb-30 tg-heading-subheading animation-style3">
                                            <span class="sub-title ">Graphic Design Packages For</span>
                        ...
                        <div class="choose-shape-wrap">
                            <img src="{{ asset('frontend') }}/assets/img/images/choose_shape01.png" alt="Apexa"
                                data-aos="fade-right" data-aos-delay="400" />
                            <img class="dark-opacity" src="{{ asset('frontend') }}/assets/img/images/choose_shape02.png"
...
$icons = [0 => 'flaticon-trophy', 1 => 'flaticon-happy', 2 => 'flaticon-user'];
                    ...
                    <section class="request-area request-bg" data-background="{{ $requestsrc }}">
                                ...
                                <div class="col-lg-8">
                                    <div class="request-content text-center tg-heading-subheading animation-style3">
                                        ...
                                        <div class="content-bottom">
                                            <a href="tel:{{ $setting['site_phone'] ?? '' }}" class="btn text-white">Request a
                                                Call</a>
                        ...
                        <div class="request-shape">
                            <img src="{{ asset('frontend') }}/assets/img/images/request_shape01.png" alt="Apexa"
                                data-aos="fade-right" data-aos-delay="400" />
                            <img src="{{ asset('frontend') }}/assets/img/images/request_shape02.png" alt="Apexa"
