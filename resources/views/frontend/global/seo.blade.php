...
<title>{{ $title ?? '' }} - Amazing Infosys</title>
@if ($description)
...
<meta property="og:title" content="{{ $title ?? '' }} - Amazing Infosys" />
@if ($description)
    <meta property="og:description" content="{{ $description ?? '' }}" />
@endif
<meta property="og:url" content="{{ Request::url() }}" />
<meta property="og:site_name" content="{{ $title ?? '' }} - Amazing Infosys" />
<meta property="article:publisher" content="https://www.facebook.com/wandertravel/" />
    ...
    <script type="application/ld+json">
        {
            ...
            "@graph":[
                ...
                },
                {
                    "@type":"Organization",
                    "@id":"{{ url('/') }}/#organization",
                    "name":"Amazing Infosys & Expedition P. Ltd",
                    "url":"{{ url('/') }}/",
                    "logo":{
                        "@type":"ImageObject",
                        "inLanguage":"en-US",
                        ...
                        "height":{{ $logoheight ?? '' }},
                        "width":{{ $logowidth ?? '' }},
                        "caption":"Amazing Infosys & Expedition P. Ltd"
                    },
                    "image":{
                        "@id":"{{ url('/') }}/#/schema/logo/image/"
                    },
                    "sameAs":[
                        "https://www.facebook.com/wandertravel/",
                        "https://www.instagram.com/wandertravel/",
                    ]
                }
            ]
        }
