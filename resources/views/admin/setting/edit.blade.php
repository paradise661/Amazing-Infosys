...
@section('title', 'Website Settings - Amazing Infosys')
                                    ...
                                    <div class="col-9 col-sm-10 tab-content" id="v-pills-tabContent">
                                        <div class="tab-pane fade show active" id="v-pills-global" role="tabpanel"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3 mt-2">
                                                        <label for="home_contact">Home Contact Image</label>
                                                        <div class="custom-file">
                                                            <a class="home_contact-modal" data-bs-toggle="modal"
                                                                data-bs-target="#home_contactModel"
                                                                href="javascript:void(0)">
                                                                <div
                                                                    class="upload-media border border-2 d-flex justify-content-center align-items-center mb-3">
                                                                    <div
                                                                        class="thumbnails media-wrapper d-flex justify-content-center align-items-center">
                                                                        @if ($settings['home_contact_image'])
                                                                            @php
                                                                                $home_contact = get_media($settings['home_contact_image'] ?? '');
                                                                            @endphp
                                                                            <img id="home_contact_img"
                                                                                src="{{ asset($home_contact->fullurl) }}"
                                                                                alt="{{ $home_contact->alt }}">
                                                                        @else
                                                            ...
                                                            <a class="btn btn-sm btn-danger d-none"
                                                                id="home_contact_remove" href="javascript:void(0)"><i
                                                                    class="fa fa-trash"></i>
                                                                Delete</a>

                                                            <input class="" id="home_contact_id" type="hidden"
                                                                name="home_contact_image"
                                                                value="{{ old('home_contact_image', $settings['home_contact_image']) }}">
                                                            @error('home_contact_image')
                                                                <div class="invalid-feedback" style="display: block;">
                                                                    {{ $message }}
                                                                </div>
                                                            @enderror
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3 mt-2">
                                                        <label for="about_contact">About Contact Image</label>
                                                        <div class="custom-file">
                                                            <a class="about_contact-modal" data-bs-toggle="modal"
                                                                data-bs-target="#about_contactModel"
                                                                href="javascript:void(0)">
                                                                <div
                                                                    class="upload-media border border-2 d-flex justify-content-center align-items-center mb-3">
                                                                    <div
                                                                        class="thumbnails media-wrapper d-flex justify-content-center align-items-center">
                                                                        @if ($settings['about_contact_image'])
                                                                            @php
                                                                                $about_contact = get_media($settings['about_contact_image'] ?? '');
                                                                            @endphp
                                                                            <img id="about_contact_img"
                                                                                src="{{ asset($about_contact->fullurl) }}"
                                                                                alt="{{ $about_contact->alt }}">
                                                                        @else
                                                                            <img class="custom-width"
                                                                                id="about_contact_img"
                                                                                src="{{ asset('admin/assets/images/upload.png') }}"
                                                                                alt="upload-image">
                                                                        @endif
                                                                    </div>
                                                            ...
                                                            <a class="btn btn-sm btn-danger d-none"
                                                                id="about_contact_remove" href="javascript:void(0)"><i
                                                                    class="fa fa-trash"></i>
                                                                Delete</a>

                                                            <input class="" id="about_contact_id" type="hidden"
                                                                name="about_contact_image"
                                                                value="{{ old('about_contact_image', $settings['about_contact_image']) }}">
                                                            @error('about_contact_image')
                                                                <div class="invalid-feedback" style="display: block;">
                                                                    {{ $message }}
                                                                </div>
                                                            @enderror
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group mb-3">
                                                                            ...
                                                                            <input class="form-control" type="text"
                                                                                name="servicetitle"
                                                                                value="{{ $settings['servicetitle'] ?? '' }}">
                                                                        </div>
                                                                        <div class="form-group mb-3">
                                                                            <label for="serviceinfo">Service Info</label>
                                                                            <textarea class="form-control br-8" name="serviceinfo" rows="4" placeholder="Enter Something ...">{{ $settings['serviceinfo'] ?? '' }}</textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        @if ($settings['services'])
                                                                            <div class="d-flex gap-2 my-3 flex-wrap">
                                                                                @foreach ($settings['services'] as $id)
                                                                                    @php
                                                                                        $footcat = getServiceByID($id);
                                                                                    @endphp
                                                                                    @if ($footcat)
                                                                                        <span
                                                                                            class="badge bg-success">{{ $footcat->name }}</span>
