...
@section('title', 'Edit ' . $page->name . ' - Amazing Infosys')
                        ...
                        <div class="card-body card shadow br-8">
                            ...
                            <div class="form-group mb-3 d-flex align-items-center">
                                ...
                                <select class="form-select ms-5" id="template" name="template">
                                    <option class="p-3" value="0"
                                        @if ($page->template == 0) selected @endif>Default Template</option>
                                    <option class="p-3" value="1"
                                        @if ($page->template == 1) selected @endif>Side-To-Side</option>
                                    <option class="p-3" value="2"
                                        @if ($page->template == 2) selected @endif>About Us</option>
                                    <option class="p-3" value="3"
                                        @if ($page->template == 3) selected @endif>Contact Us</option>
                                    <option class="p-3" value="4"
                                        @if ($page->template == 4) selected @endif>Teams</option>
                                    <option class="p-3" value="5"
                                        @if ($page->template == 5) selected @endif>Reviews</option>
                                    <option class="p-3" value="6"
                                        @if ($page->template == 6) selected @endif>Faqs</option>
                                    <option class="p-3" value="7"
                                        @if ($page->template == 7) selected @endif>Partners</option>
                                    <option class="p-3" value="8"
                                        @if ($page->template == 8) selected @endif>Blogs</option>
                                    <option class="p-3" value="9"
                                        @if ($page->template == 9) selected @endif>Services</option>
                                    <option class="p-3" value="10"
                                        @if ($page->template == 10) selected @endif>Gallery</option>
                                    <option class="p-3" value="11"
                                        @if ($page->template == 11) selected @endif>Blog Category</option>
                                    <option class="p-3" value="12"
                                        @if ($page->template == 12) selected @endif>Projects</option>
                                    <option class="p-3" value="14"
                                        @if ($page->template == 14) selected @endif>Code</option>
                                    <option class="p-3" value="13"
                                        @if ($page->template == 13) selected @endif>Sitemap</option>
                                </select>
                            </div>
