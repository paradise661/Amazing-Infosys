...
@section('title', 'Create New Page - Amazing Infosys')
                        ...
                        <div class="card-body card shadow br-8">
                            ...
                            <div class="form-group mb-3 d-flex align-items-center">
                                ...
                                <select class="form-select ms-3" id="template" name="template">
                                    ...
                                    <option class="p-3" value="5">Reviews</option>
                                    <option class="p-3" value="6">Faqs</option>
                                    <option class="p-3" value="7">Partners</option>
                                    <option class="p-3" value="8">Blogs</option>
                                    <option class="p-3" value="9">Services</option>
                                    <option class="p-3" value="10">Gallery</option>
