...
@section('title', 'Edit ' . $project->name . ' - Amazing Infosys')
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control br-8 @error('client') is-invalid @enderror"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control br-8 @error('category') is-invalid @enderror"
                                            type="text" name="category" value="{{ old('category', $project->category) }}"
                            ...
                            <fieldset class="border p-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control br-8" type="text" name="seo_title"
                                        value="{{ old('seo_title', $project->seo_title) }}" placeholder="Enter Seo Title">
                                </div>
                                <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control br-8" name="seo_schema" rows="10" placeholder="Enter Seo Schema">{{ old('seo_schema', $project->seo_schema) }}</textarea>
                                </div>
                            </fieldset>
                        </div>
                    </div>
                            ...
                            <div class="form-group mb-3 d-flex align-items-center">
                                ...
                                <select class="form-select ms-5" id="status" name="status">
                                    <option class="p-3" value="0"
                                        ...
                                        Draft</option>
                                    <option class="p-3"@if ($project->status == 1) selected @endif
                                        value="1">
                                        Publish</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group mb-3 mt-2">
                                ...
                                <div class="custom-file">
                                    <a class="banner-modal" data-bs-toggle="modal" data-bs-target="#bannerModel"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                @if ($project->banner)
                                                    @php
                                                        $banner = get_media($project->banner ?? '');
                                                    @endphp
                                    ...
                                    <input class="" id="banner_id" type="hidden" name="banner"
                                        value="{{ old('banner', $project->banner) }}">
                                    @error('banner')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                        </div>
